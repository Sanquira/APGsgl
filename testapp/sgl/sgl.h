...
/**
  ...
  Always draws a circular arc, no matter the possible non-uniform scale or
  squash in the current transform matrices. In addition, the depth of all the
  generated fragments is constant and equal to the depth of the transformed
  circle center. Use approximation by a linestrip / polygon of exactly
  40 * |to - from| / (2 * PI) vertices (so that the speed measurements are fair).
